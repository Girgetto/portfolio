	...
	>
      ...
      Assistant and from April 2019 part of the{' '}
		...
		<a
			target="_blank"
			rel="noopener noreferrer"
			href="https://www.facebook.com/ggrassini"
		>
		...
		<a
			target="_blank"
			rel="noopener noreferrer"
			href="https://plus.google.com/u/0/112911520666250234745"
		>
...
=======
  <div className="container" style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid #eee' }}>
    ...
    <p>
          ...
          the same time I was working for
      {' '}
      <a href="http://www.hotelvillacasalecchi.com">Hotel Villa Casalecchi</a>
      {' '}
as IT. Moved to
          Madrid in 2017 to increase my knowledge in programming at
      {' '}
...
team.
    ...
    <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/giorgio-grassini-458023150/">
      <i className="fab fa-linkedin fa-2x" />
    </a>
    ...
    <a target="_blank" rel="noopener noreferrer" href="mailto:giorgiograssini@gmail.com">
      <i className="fas fa-envelope-square fa-2x" />
    </a>
  </div>
>>>>>>> d29f56df9714674d04ea25b75c4a7197f5c8b75e
);
